...
├── brand-data.md                     # Brand-specific data. SWAP THIS (or rebuild it) for a different brand.
├── README.md                         # This file.
├── templates/
