...
description: "Research, write, and publish SEO and AI-answer-engine optimised blog posts and advertorial or founder-story sales pages for a Shopify store, end to end. Use whenever the user wants a blog post, blog article, blog idea, store blog content, an SEO article, a how-to, listicle, comparison, buying guide, product-review post, pillar or ultimate guide, FAQ or answer post, myth-busting post, or an advertorial, PR or news-style article, native advertising piece, founder story, our-story page, or story-led sales page. Also trigger for \"what should I blog about\", \"find blog topics\", \"research keywords for content\", \"write an article about X\", \"turn this product into a blog post\", \"write an advertorial\", or \"publish this to Shopify\", or any request for content built to get cited in Google and AI engines like ChatGPT and Perplexity, to convert paid traffic, or to drive clicks to products. Publishes to Shopify as a draft for review."
---
