...
description: "Write UGC-style short-form video scripts a brand can shoot themselves or hand to a creator, built to grab attention in the first 3 seconds, hold it, and drive an action. Use whenever the user wants a video script, UGC script, ad script, TikTok, Reels or Shorts script, organic video idea, founder story video, a \"3 reasons why\" video, comment-reply video, product-review video, interview, street or podcast-style video, an us-vs-them or before-and-after video, an unboxing video, a creator brief, or a hook for a video. Also trigger for \"script me a video\", \"give me a UGC ad\", \"what should I film\", \"turn this product into a video\", \"I need content for ads or social\", or when the user is choosing which video format suits their goal. Covers a growing set of UGC video types, with Founder Ad Story, 3 Reasons Why and Comment Reply live now. Works for any brand, preferring the brand profile in brand-intelligence and falling back to this skill's own config."
---
